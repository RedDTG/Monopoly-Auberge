...
PiocheProprietes::PiocheProprietes() {
	...
	this->PiocheProp.push_back(new CartePropriete("EPSI", 200, 25, "Noir", 2, 15));
	...
	this->PiocheProp.push_back(new CartePropriete("La boite qui apprend", 150, 10, "Noir", 3, 15));
	...
	this->PiocheProp.push_back(new CartePropriete("Warehouse", 200, 25, "Noir", 2, 15));
	...
	this->PiocheProp.push_back(new CartePropriete("Chez DHB", 200, 25, "Noir", 2, 15));
	...
	this->PiocheProp.push_back(new CartePropriete("Beecome", 150, 10, "Noir", 3, 15));
	...
	this->PiocheProp.push_back(new CartePropriete("Auberge", 200, 25, "Noir", 2, 15));
