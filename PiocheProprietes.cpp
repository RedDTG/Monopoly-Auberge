...
PiocheProprietes::PiocheProprietes() {
	...
	this->PiocheProp.push_back(new Gare("EPSI", 200, 50));
	...
	this->PiocheProp.push_back(new Gare("Warehouse", 200, 100));
	...
	this->PiocheProp.push_back(new Gare("Chez DHB", 200, 150));
	...
	this->PiocheProp.push_back(new Gare("Auberge", 200, 200));
